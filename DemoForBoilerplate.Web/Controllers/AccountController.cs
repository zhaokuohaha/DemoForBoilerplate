...
using DemoForBoilerplate.Web.Controllers.Results;
using DemoForBoilerplate.Web.Models.Account;
...
{
    public class AccountController : DemoForBoilerplateControllerBase
    {
